         ...
         <main className='main_front_section'  data-aos="fade-up">
                ...
                <div className='about_me'>
                    ...
                    <div className='profile_section'>
                        <h3>
                        원하는 결과를 얻기 위해 도전을 마다하지 않는, <br/> 신입프론트엔드 강예진입니다.</h3>
                        <p> 저는 활발하고 강한 사람입니다.<br/>
                            할일에 대해 끝까지 책임을 가지고, 주어진 상황을 인지하고 
                            현실의 문제를 해결하는 것이 우선이라고 생각합니다.<br/>
                            항상 실수 하지 않기 위해 노력하고 자존심보다는 냉정한 평가를 받아 들이려고 합니다.
                        </p>
                        <p> 평소 컴퓨터나 인터넷 기술에 대해 관심이 많았습니다.<br/>
                            진로에 대해 고민하다가 IT기술을 배우게 된다면 경쟁력이 있을거라 생각하고 
                            프로그래밍 공부를 시작했습니다.<br/>
                            처음에는 책이나 유튜브를 통해 기본기를 공부하였고, 그 이후 국비지원 학원을 다니며 
                            조금 더 깊이있는 공부를 배우게 되었습니다.
                        </p>
                    </div>
                </div>
